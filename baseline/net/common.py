...
'''
#### kitti dataset orijection from lidar to top, front and rgb #### Old values from the hengck
TOP_Y_MIN=-20  #40
TOP_Y_MAX=+20
TOP_X_MIN=0
TOP_X_MAX=40   #70.4
...
# Min max for lidar KITTI points determined from one frame (not global min max)
TOP_X_MIN=-70
TOP_X_MAX=70   #70.4
TOP_Y_MIN=-80  #40
TOP_Y_MAX=80
